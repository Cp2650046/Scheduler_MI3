...
function main_switch_project(){
    return new Promise(async (resolve, reject)=>{
        ...
        console.log(switched ? 'get switch' : 'get local')
    ...
    return new Promise(async (resolve, reject)=>{
        ...
        $(".btn-action-group").on("click", (e)=>{
            ...
            switch(id){
                ...
                return
                case 'update':
                    if(typeof click_btn_update === "function"){
                        click_btn_update()
                        return
                    }
                    toastr.warning('no function handler update')
                return
                case 'delete':
                    if(typeof click_btn_delete === "function"){
                        click_btn_delete()
                        return
                    }
                    toastr.warning('no function handler delete')
                return
                case 'approve':
                    if(typeof click_btn_approve === "function"){
                        click_btn_approve()
                        return
                    }
                    toastr.warning('no function handler approve')
                return
                case 'reject':
                    if(typeof click_btn_reject === "function"){
                        click_btn_reject()
                        return
                    }
                    toastr.warning('no function handler reject')
                return
                default:
...
function main_render_autocomplete(element_key, element_show, data_source, field_key, field_show, field_show_status){
    ...
    $('#'+element_key).autocomplete({
        ...
        search: function(event, ui){
            $('#'+element_key).autocomplete({ source: data_source })
        },
...
function main_validate_number(e){
